      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const Text('Camera access required', style: TextStyle(color: Colors.white70)),
            const SizedBox(height: 8),
            TextField(
              controller: _qrTextController,
              style: const TextStyle(color: Colors.white),
              decoration: const InputDecoration(
                hintText: 'Or enter QR content manually',
          ...
          children: [
            ...
            if (_scannedResult.isNotEmpty) ...[
              ...
              Container(
                ...
                child: Column(
                  children: [
                    const Text('Scanned Result:', style: TextStyle(color: Color(0xFF00BCD4))),
                    const SizedBox(height: 8),
